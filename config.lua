...
Config.Impound = {
    -- จุดสำหรับพลเมือง (ดูรถที่ถูกยึด)
    Citizen = {
        enabled = true,
        model = `s_m_m_security_01`,
        coords = vec4(445.0, -961.26, 29.25, 15.29),
        icon = "fas fa-warehouse",
    },
    
    -- จุดสำหรับตำรวจ (ตรวจสอบและคืนรถ)
    Officer = {
        enabled = true,
        model = `s_m_m_security_01`,
        coords = vec4(478.27, -907.56, 28.46, 5.07),
        icon = "fas fa-address-card",
        job = "police", 
        searchRadius = 10.0, 
    },

    SpawnCoords = vec4(472.73, -896.56, 27.89, 179.38)
}
